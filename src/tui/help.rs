...
fn vim_help_text() -> Vec<String> {
    vec![
        ...
        "  0 / $          First/last data column in row",
        "  Ctrl+Home/End  Go to first/last cell",
        "  g + <key>      Open goto prompt",
        ...
        "  o / O          Open row below/above and edit",
        ...
        "  yy             Yank entire row",
        "  p              Paste at cursor",
        "  zf / zF        Freeze cell / freeze all formulas",
...
fn emacs_help_text() -> Vec<String> {
    vec![
        ...
        "",
        "Search",
        "  M-s or /       Open regex search prompt",
        "  M-r            Next search match",
        "",
        "Editing",
        "  Enter          Edit cell",
...
pub fn get_commands_help() -> Vec<String> {
    vec![
        ...
        "  :save [file]   Alias for :w",
        "  :q             Quit (warns if unsaved)",
        "  :q!            Force quit (discard changes)",
        "  :wq            Save and quit",
        "  :e <file>      Open file",
        "  :open <file>   Alias for :e",
        "  :load <file>   Alias for :e",
        "  :new           New empty document",
        "  :new!          New document (discard unsaved changes)",
        "",
        "Navigation",
        ...
        "",
        "Search",
        "  /<pattern>     Regex search in command line",
        "  :find <pat>    Search by regex",
        "  :search <pat>  Alias for :find",
        "  Keys: Vim n/N, Emacs M-r (next)",
        "",
        ...
        "  :freeze / :fr  Freeze formula/spill at cursor",
        "  :freezeall / :fa  Freeze all formulas and spills",
        "",
        "Functions & Scripts",
...
fn action_label(action: &Action) -> &'static str {
    match action {
        ...
        Action::SelectRow => "Select entire row",
        ...
        Action::FreezeCell => "Freeze current formula",
        Action::FreezeAll => "Freeze all formulas",
        Action::HomeDataCol => "First data column in row",
        Action::EndDataCol => "Last data column in row",
        Action::OpenRowBelowEdit => "Open row below and edit",
        Action::OpenRowAboveEdit => "Open row above and edit",
